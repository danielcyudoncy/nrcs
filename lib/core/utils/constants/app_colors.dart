// core/utils/constants/app_colors.dart
...
class AppColors {
  ...
  static const white = Color(0xFFFFFFFF); // Keep existing off-white
  static const errorRed = Color(0xFFB61F24);

  // Updated to match app theme colors
  static const primaryColor = Color(0xFF022D62); // Channels TV primary blue
  static const secondaryColor = Color(0xFF253EBC); // Channels TV secondary blue
  static const tertiaryColor = Color(0xFF333333); // Keep existing
  static const saveColor = Color(0xFF4F6FD2); // Match primary blue
  ...
  static const Color darkBackground = Color(
    0xFF022D62,
  ); // Theme dark surface variant
  static const Color darkCard = Color(0xFF022D62); // Theme primary blue
  static const Color darkAppBar = Color(0xFF253EBC); // Match primary
